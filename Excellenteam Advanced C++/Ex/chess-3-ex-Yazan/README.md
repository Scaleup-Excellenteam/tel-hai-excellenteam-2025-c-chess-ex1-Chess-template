...
## Exercise: Multithreaded Chess 

At This Exercise I Had Add My Solution For The Excellenteam C++ Chess Multithreading Exercise.

- At The Main Program We Simulate Automtic Chess Game Where The Calculation Of The Moves Is Performed In Parallel Using ThreadPool And PriorityQueue. 
- All The The Source Files Are Located In The src Folder, And The Headrs Files Are The include Folder. 
- We Can Run This Project By This Steps:
1. mkdir build - At The Project Folder.
2. cd build 
3. cmake ..
4. make 
5. ./Chess

- The Main Threads Logic Is In src/RunChess.cpp And src/ThreadPool.cpp Files.
