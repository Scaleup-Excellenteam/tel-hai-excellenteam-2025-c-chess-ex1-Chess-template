...
# Parse arguments
# FIX: Change --test to --tests to match your command, or vice-versa.
# Let's make it accept either --test or --tests for flexibility.
...
if $RUN_TESTS; then
    ...
    # FIX: Add $ to correctly reference the variable
    exec "$test_exe_path"
else
    exe_path=""
